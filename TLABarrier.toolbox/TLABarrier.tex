...
\@x{}\moduleLeftDash\@xx{ {\MODULE} TLABarrier}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
\@x{ {\CONSTANT} threads ,\, num\_threads}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLE} TState ,\, n ,\, BState}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq} \.{\land} n \.{=} num\_threads}%
 \@x{\@s{35.70} \.{\land} TState \.{=} [ t \.{\in} threads \.{\mapsto}\@w{pre}
 ]}%
\@x{\@s{35.70} \.{\land} BState\@s{0.11} \.{=}\@w{init}}%
\@pvspace{8.0pt}%
\@x{ First ( r ) \.{\defeq} \.{\land} BState\@s{0.11} \.{=}\@w{init}}%
 \@x{\@s{54.13} \.{\land} TState \.{\in} [ threads \.{\rightarrow} \{\@w{pre}
 \} ]}%
\@x{\@s{54.13} \.{\land} BState \.{'}\@s{0.11} \.{=}\@w{stop}}%
 \@x{\@s{54.13} \.{\land} TState \.{'} \.{=} [ TState {\EXCEPT} {\bang} [ r ]
 \.{=}\@w{at} ]}%
\@x{\@s{54.13} \.{\land} {\UNCHANGED} {\langle} n {\rangle}}%
\@pvspace{8.0pt}%
\@x{ AdvanceTo ( r ) \.{\defeq} \.{\land} BState \.{=}\@w{stop}}%
\@x{\@s{80.14} \.{\land} TState [ r ] \.{\neq}\@w{at}}%
 \@x{\@s{80.14} \.{\land} ( \E\, t \.{\in} threads \.{:} TState [ t
 ]\@s{28.00} \.{\neq}\@w{at} )}%
 \@x{\@s{80.14} \.{\land} TState \.{'} \.{=} [ TState {\EXCEPT} {\bang} [ r ]
 \.{=}\@w{at} ]}%
\@x{\@s{80.14} \.{\land} {\UNCHANGED} {\langle} n ,\, BState {\rangle}}%
\@pvspace{8.0pt}%
\@x{ AdvanceToLast ( r ) \.{\defeq} \.{\land} BState \.{=}\@w{stop}}%
\@x{\@s{98.74} \.{\land} TState [ r ] \.{\neq}\@w{at}}%
\@x{\@s{98.74} \.{\land} ( \A\, t \.{\in} threads \.{:} \.{\lor} t \.{=} r}%
\@x{\@s{178.26} \.{\lor} TState [ t ] \.{=}\@w{at} )}%
 \@x{\@s{98.74} \.{\land} TState \.{'} \.{=} [ TState {\EXCEPT} {\bang} [ r ]
 \.{=}\@w{at} ]}%
\@x{\@s{98.74} \.{\land} BState \.{'}\@s{0.11} \.{=}\@w{pass}}%
\@x{\@s{98.74} \.{\land} {\UNCHANGED} {\langle} n {\rangle}}%
\@pvspace{8.0pt}%
\@x{ AdvancePast ( r ) \.{\defeq} \.{\land} BState \.{=}\@w{pass}}%
 \@x{\@s{88.26} \.{\land} TState \.{'} \.{=} [ TState {\EXCEPT} {\bang} [ r ]
 \.{=}\@w{thru} ]}%
\@x{\@s{88.26} \.{\land} {\UNCHANGED} {\langle} n ,\, BState {\rangle}}%
\@pvspace{8.0pt}%
 \@x{ Done \.{\defeq} \.{\land} TState \.{\in} [ threads \.{\rightarrow}
 \{\@w{thru} \} ]}%
 \@x{\@s{42.52} \.{\land} {\UNCHANGED} {\langle} TState ,\, BState ,\, n
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ TNext ( r ) \.{\defeq} \.{\lor} First ( r )}%
\@x{\@s{60.05} \.{\lor} AdvanceTo ( r )}%
\@x{\@s{60.05} \.{\lor} AdvanceToLast ( r )}%
\@x{\@s{60.05} \.{\lor} AdvancePast ( r )}%
\@pvspace{8.0pt}%
 \@x{ TypeOK \.{\defeq} \.{\land} TState \.{\in} [ threads \.{\rightarrow}
 \{\@w{pre} ,\,\@w{at} ,\,\@w{thru} \} ]}%
 \@x{\@s{56.14} \.{\land} BState\@s{0.11} \.{\in} \{\@w{init} ,\,\@w{stop}
 ,\,\@w{pass} \}}%
\@pvspace{16.0pt}%
\@x{ BarrierNext \.{\defeq}\@s{4.1} \.{\lor} Done}%
\@x{\@s{76.39} \.{\lor} ( \E\, t \.{\in} threads \.{:}\@s{4.1} TNext ( t ) )}%
\@pvspace{8.0pt}%
 \@x{ Spec \.{\defeq} Init \.{\land} {\Box} [ BarrierNext ]_{ {\langle} TState
 ,\, n ,\, BState {\rangle}}}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Mar} 19 16:12:18 \ensuremath{PDT} 2019 by \ensuremath{JAlbers
}%
\end{cpar}%
\end{lcom}%
\end{document}
